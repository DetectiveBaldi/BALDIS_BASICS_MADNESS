...
class Playlist
{
    public static function init():Void
    {
        ...
        week.levels.pushMultiple(new LevelData(week, "Warm Welcome"), new LevelData(week, "Revision"), 
            new LevelData(week, "Gain Ground"));

        WeekData.list.push(week);

        week = {name: "classic", description: "", levels: new Array<LevelData>()}

        WeekData.list.push(week);

        LevelData.list.push(new LevelData(week, "Rough Escape"));
    }
}