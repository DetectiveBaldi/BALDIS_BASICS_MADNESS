...
class Week1 extends FlxGroup
{
    ...
    public function new():Void
    {
        ...
        background = new FlxSprite(0, 0, Assets.getGraphic("game/stages/Week1/background"));
        ...
        foreground = new FlxSprite(0, 0, Assets.getGraphic("game/stages/Week1/foreground"));
        ...
        curtains = new FlxSprite(0, 0, Assets.getGraphic("game/stages/Week1/curtains"));
